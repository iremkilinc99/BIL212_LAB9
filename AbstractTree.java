...
public abstract class AbstractTree<E> implements Tree<E> {
   ...
   */
  @Override
  public Iterable<Position<E>> positions() { return preorder(root()); }
   ...
   */
  protected List<Position<E>>preorderSubtree(Position<E> p, List<Position<E>> snapshot) {
   ...
   */
  public Iterable<Position<E>> preorder(Position<E> localRoot) {
    List<Position<E>> snapshot = new ArrayList<>();
    if (!isEmpty())
      preorderSubtree(localRoot, snapshot);   // fill the snapshot recursively
    return snapshot;
  }
